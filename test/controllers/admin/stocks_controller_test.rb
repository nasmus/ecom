...
class Admin::StocksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_stock" do
    assert_difference("Admin::Stock.count") do
      post admin_stocks_url, params: { admin_stock: { price: @admin_stock.price, size: @admin_stock.size } }
    end
  ...
  test "should update admin_stock" do
    patch admin_stock_url(@admin_stock), params: { admin_stock: { price: @admin_stock.price, size: @admin_stock.size } }
